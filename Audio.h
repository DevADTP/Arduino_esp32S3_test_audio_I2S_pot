...
#ifdef _MODIF_SULSULDEV
//sulsuldev
extern unsigned char decrypredData[16];
extern unsigned char decrypredDataBig[2048];
extern unsigned char encrypredDataBig[2048];
extern unsigned char encrypredData[16];
extern uint32_t nrOfDecryptedBytes;
extern mbedtls_aes_context aes;
extern char *keycrypt;
#endif
